...
param_grid = {'batch_size': [1], #Initialize to optimized hyperparameter value from Param_Optimization_1
              ...
              'epochs': [100], #Initialize to optimized hyperparameter value from Param_Optimization_1
